...
4. 框架的搭建
   ...
   - com.bubudeai.service

   - com.bubudeai.controller
...
3. 编写数据库对应的实体类：com.bubudeai.pojo.Books（lombok插件处理getset）
...
1. 配置Spring整合MyBatis，使用druid 数据源连接池

2. 编写Spring 整合Mybatis的相关的配置文件；spring-dao.xml
